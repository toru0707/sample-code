...
/**
 *
 * Simple test which demonstrates how a test can be run against Mobile Safari running on an Appium
 * instance.
 *
 * The test is based on
 * https://github.com/appium/appium/blob/master/sample-code/examples/node/safari.js
 *
 */
public class SafariTest {
    ...
    public void runTest() throws Exception {
        ...
        assertTrue(driver.findElement(By.id("your_comments"))
                .getText()
                .contains("This is an awesome comment"));
